...
export class AttachmentsApi {
     ...
     */
    public async findAttachment (attachmentId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Attachment;  }> {
     ...
     * @param attachmentId Attachment id
     */
    public async findAttachmentData (attachmentId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Buffer;  }> {
